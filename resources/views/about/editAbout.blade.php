...
<form class="m-3" action="{{route('updateAbout', $about->id)}}" method="post">
    ...
    <section class="container">
        <textarea class="m-3 form-control @error('texte') is-invalid @enderror" type="text" name="texte" id="" rows="10" cols="50" placeholder="Veuillez saisir le texte">{{$about->texte}}</textarea>
        @error('texte')
